...
//        val viewPage2 = findViewById<ViewPager2>(R.id.my_viewpager2)
//        val pager2Adapter = MyViewPager2Adapter()
//        viewPage2.adapter = pager2Adapter
    }

//    private fun someCodeInOnCreate(savedInstanceState: Bundle?) {
//        // 点数
//        mTextView = findViewById<TextView>(R.id.tv_data)
//        // 骰子图片
//        mDiceImg = findViewById<ImageView>(R.id.diceImg)
